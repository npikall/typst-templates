...
= Lesen von externen Dateien

Es ist möglich externe Dateien in die Hauptdatei einzubinden. In diesem Fall wird eine CSV Datei eingebunden und die Daten in einer Tabelle ausgegeben.

#let results = csv("features/data.csv")
#table(
  columns: 4,
  ..results.flatten(),
)